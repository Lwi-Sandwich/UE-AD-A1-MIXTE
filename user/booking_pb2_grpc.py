...
class BookingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddBooking = channel.unary_unary(
                '/Booking/AddBooking',
                request_serializer=booking__pb2.NewBookingInfo.SerializeToString,
                response_deserializer=booking__pb2.UserBooking.FromString,
                _registered_method=True)
...
def add_BookingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AddBooking': grpc.unary_unary_rpc_method_handler(
                    servicer.AddBooking,
                    request_deserializer=booking__pb2.NewBookingInfo.FromString,
                    response_serializer=booking__pb2.UserBooking.SerializeToString,
            ),
    }
...
class Booking(object):
    ...
    def AddBooking(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Booking/AddBooking',
            booking__pb2.NewBookingInfo.SerializeToString,
            booking__pb2.UserBooking.FromString,
            options,
            channel_credentials,
            insecure,
